...
for i = 7:10
filename = strcat('42_logsig_10_',num2str(i)); %save to file
tic 
...
net_mu.layers{end}.size = 4; % output is the parameter

net_mu.layers{end}.transferFcn = 'logsig'; %tansig, logsig, poslin, softmax
...
function plotting(t_exp1,y_exp1,t_exp2,y_exp2,t,y)
    ...
    xlabel('Time');
    ylabel('y(t)');
    title('Hybrid ODE-ANN Model with 4 Optimized Parameters');
end