...
function [poslin,tansig,logsig] = saveHypSearchResTimeOnly(folder)
cd(folder)
% Iterate through all files
matFiles = dir('*.mat');

% Define empty arrays for time for each hyperparameter combination
poslin_5_time = [];
poslin_5_5_time = [];
poslin_10_time = [];
poslin_10_10_time = [];
...
for k = 1:length(matFiles)
    ...
    time = f.time/60; %time in minutes

    if strcmp(key,'poslin_5')
        poslin_5_time = [poslin_5_time; time];
    elseif strcmp(key,'poslin_5_5')
        poslin_5_5_time = [poslin_5_5_time; time];
    elseif strcmp(key,'poslin_10')
        poslin_10_time = [poslin_10_time; time];
    elseif strcmp(key,'poslin_10_10')
        poslin_10_10_time = [poslin_10_10_time; time];
 
    elseif strcmp(key,'logsig_5')
        logsig_5_time = [logsig_5_time; time];
    elseif strcmp(key,'logsig_5_5')
        logsig_5_5_time = [logsig_5_5_time; time];
    elseif strcmp(key,'logsig_10')
        logsig_10_time = [logsig_10_time; time];
    elseif strcmp(key,'logsig_10_10')
        logsig_10_10_time = [logsig_10_10_time; time];
    elseif strcmp(key,'tansig_5')
        tansig_5_time = [tansig_5_time; time];
    elseif strcmp(key,'tansig_5_5')
        tansig_5_5_time = [tansig_5_5_time; time];
    elseif strcmp(key,'tansig_10')
        tansig_10_time = [tansig_10_time; time];
    elseif strcmp(key,'tansig_10_10')
        tansig_10_10_time = [tansig_10_10_time; time];
    end
end

[mean_poslin_5, var_poslin_5, std_poslin_5] = meanSTDandVar(poslin_5_time);
[mean_poslin_5_5, var_poslin_5_5,std_poslin_5_5] = meanSTDandVar(poslin_5_5_time);
[mean_poslin_10, var_poslin_10,std_poslin_10] = meanSTDandVar(poslin_10_time);
[mean_poslin_10_10, var_poslin_10_10,std_poslin_10_10] = meanSTDandVar(poslin_10_10_time);

[mean_tansig_5, var_tansig_5, std_tansig_5] = meanSTDandVar(tansig_5_time);
[mean_tansig_5_5, var_tansig_5_5, std_tansig_5_5] = meanSTDandVar(tansig_5_5_time);
[mean_tansig_10, var_tansig_10, std_tansig_10] = meanSTDandVar(tansig_10_time);
[mean_tansig_10_10, var_tansig_10_10, std_tansig_10_10] = meanSTDandVar(tansig_10_10_time);

[mean_logsig_5, var_logsig_5,std_logsig_5] = meanSTDandVar(logsig_5_time);
[mean_logsig_5_5, var_logsig_5_5,std_logsig_5_5] = meanSTDandVar(logsig_5_5_time);
[mean_logsig_10, var_logsig_10,std_logsig_10] = meanSTDandVar(logsig_10_time);
[mean_logsig_10_10, var_logsig_10_10,std_logsig_10_10] = meanSTDandVar(logsig_10_10_time);
...
poslin(:,4) = [length(poslin_5_time);length(poslin_5_5_time);length(poslin_10_time);length(poslin_10_10_time)];
...
tansig(:,4) = [length(tansig_5_time);length(tansig_5_5_time);length(tansig_10_time);length(tansig_10_10_time)];
...
logsig(:,4) = [length(logsig_5_time);length(logsig_5_5_time);length(logsig_10_time);length(logsig_10_10_time)];
end
...
% 
% initializeExcel(fn)
% % writeToExcel(fn,actfunArray,structArray, timeArray);%,STD,Var)
% 
% 
